class Sphere3D {
    ...
    generateSpherePoints() {
        ...
        // Generar puntos en la esfera con el radio actual
    ...
    adjustDistanceOnRadiusChange(newRadius) {
        // Cambiar la distancia entre los puntos en base al nuevo radio
        const scaleFactor = newRadius / this.lastRad;

        this.spherePoints = this.spherePoints.map(point => {
            return point.map(coord => coord * scaleFactor);
        });

        // Actualizar el radio
        this.lastRad = newRadius
        this.rad = newRadius;
    }
    ...
    initMouseMovement() {
        ...
        // Si el mouse sale de la ventana (mouseout), ponemos usingMouse en false
